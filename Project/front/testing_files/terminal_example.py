...
def radial_distance(body1, body2, utc, ref, abcorr, obs):
    ...
    d_rad = ((x_2 - x_1)**2.0 + (y_2 - y_1)**2.0 + (z_2 - z_1)**2.0)
...
class Ui_window1(object):
    def setupUi(self, window1):
        ...
        self.testBtn = QtWidgets.QPushButton(self.groupBox_2)
        self.testBtn.setText("hello")
        self.testBtn.setGeometry(QtCore.QRect(10, 10, 200, 40))
        self.testBtn.clicked.connect(self.Btn)

        self.testBtn2 = QtWidgets.QPushButton(self.groupBox_2)
        self.testBtn2.setText("clear")
        self.testBtn2.setGeometry(QtCore.QRect(220, 10, 200, 40))
        self.testBtn2.clicked.connect(self.Btn2)
