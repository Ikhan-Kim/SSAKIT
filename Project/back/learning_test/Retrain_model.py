...
def Retrain(augmentation, input_epochs, train_path, val_path, window, trained_model_path, new_model_name):
    #path
    ...
    # Callbacks
    checkpoint_filepath = os.path.join(BASE_DIR, 'learning_test/checkpoint/'+new_model_name +'.h5')
